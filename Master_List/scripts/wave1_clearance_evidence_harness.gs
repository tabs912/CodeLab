...
function logWave1ManualEvidenceChecklist() {
  const rows = [
    ['W1-T04', 'Existing Master List replacement cancel', 'PENDING', 'Run createMasterList, choose No, attach before/after evidence.'],
    ['W1-T05', 'Existing Master List replacement success', 'PENDING', 'Run createMasterList, choose Yes, attach screenshot/PDF/CSV proving staged promotion succeeded and no __STAGED sheet remains.'],
    ['W1-T06', 'Forced failure preserves original Master List', 'PENDING', 'Rename/remove Template - Master List in copy, run createMasterList, attach error/log and before/after evidence.'],
    ['W1-T07', 'Staged validation failure preserves original Master List', 'PENDING', 'Make staged output invalid in copy, run createMasterList, attach validation error/log and preservation evidence.'],
    ...
    ['W1-T14', 'End-to-end regression smoke', 'PENDING', 'Attach regression summary covering createMasterList, createIndexSheet, archive/raw path, and web restore smoke.']
  ];
...
function runWave1TemplatePresenceEvidence() {
  ...
  appendWave1Evidence_(
    ...
    ss.getUrl(),
    'Use before running staged Master List success and end-to-end regression tests.'
  );
  return missing;
}
...
function summarizeWave1ClearanceEvidence() {
  ...
  const required = ['W1-T01', 'W1-T02', 'W1-T03', 'W1-T04', 'W1-T05', 'W1-T06', 'W1-T07', 'W1-T08', 'W1-T09', 'W1-T10', 'W1-T11', 'W1-T12', 'W1-T13', 'W1-T14'];
  const latest = {};
  ...
  appendWave1Evidence_(
    ...
    'Wave 1 is clear only after W1-T01 through W1-T14 pass and evidence is attached.'
  );
